...
subtractive = {
    ...
    'subtractiveellipsoid': cut_ellipsoid_by_size,
    'subtractivehelix':     cut_helix_by_size,
    'subtractiveloft':      cut_loft_choose_sketches,
    'subtractivepipe':      cut_pipe_choose_sketches,
    'subtractiveprism':     cut_prism_by_size,
    'subtractivesphere':    cut_sphere_by_radius,
    'subtractivetorus':     cut_torus_by_size,
    'subtractivewedge':     cut_wedge_by_size,
    ...
    'cut_ellipsoid_by_size': cut_ellipsoid_by_size,
    'cut_wedge_by_size':    cut_wedge_by_size,
    'cut_helix_by_size':    cut_helix_by_size,
    'cut_loft_choose_sketches': cut_loft_choose_sketches,
    'cut_pipe_choose_sketches': cut_pipe_choose_sketches,
