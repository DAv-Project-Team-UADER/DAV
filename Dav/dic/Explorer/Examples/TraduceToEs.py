...
TraduceToEs = {
    ...
    'guía':           examples['manual'],
    'manual de usuario': examples['manual'],

    'ejemplos':       examples['demos'],
    'ejemplo':        examples['demos'],
    'demostraciones': examples['demos'],
    'tutorial':       examples['demos'],
    'tutoriales':     examples['demos'],

    "ayuda":          examples['help'],
    "información":    examples['help'],
    "opciones":       examples['help'],
}
