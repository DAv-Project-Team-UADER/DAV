...
TraduceToPt = {
    ...
    'referência':     examples['manual'],
    'referencia':     examples['manual'],
    'guia':           examples['manual'],
    'manual do usuário': examples['manual'],

    'exemplos':       examples['demos'],
    'exemplo':        examples['demos'],
    'demonstrações':  examples['demos'],
    'tutorial':       examples['demos'],
    'tutoriais':      examples['demos'],

    "ajuda":          examples['help'],
    "informação":     examples['help'],
    "opções":         examples['help'],
}
